...
app.post('/create', upload.single('image'), async(req, res) => {
  ...
  try {
    await db.query("INSERT INTO fighter_aircrafts (aircraft_name, country, primary_role, max_speed, first_service_year, stealth, image_url) VALUES ($1, $2, $3, $4, $5, $6, $7)", [data.name, data.country, data.role, data.max_speed, data.year, data.stealth, data.image]);
